    ...
    view! {
        <tr class=class on:click=move |mouse_event| on_select.run(mouse_event)>
            ...
            <td class="w-1 p-2 whitespace-nowrap text-ellipsis">
                ...
                //    <button
                //        class="text-slate-800 hover:text-blue-600 bg-white hover:bg-slate-100 border-[1.5px] border-slate-200 rounded-l-lg font-medium px-4 py-2 inline-flex space-x-1 items-center">
                ...
                //    </button>
                //    <button
                //        class="text-slate-800 hover:text-blue-600 bg-white hover:bg-slate-100 border-[1.5px] border-slate-200 rounded-r-lg font-medium px-4 py-2 inline-flex space-x-1 items-center">
                //        <span>
